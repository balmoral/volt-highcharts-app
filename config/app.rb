...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-highcharts-app.com'
  config.app_name = 'Volt-highcharts-app'
  config.mailer.from = 'Volt-highcharts-app <no-reply@volt-highcharts-app.com>'
  ...
  #
  config.app_secret = 'C3fVVy5L9JHKSJ5pRmsXJqXrQYgNoii9fQYDc3vN0a6gLUsjVCRlXJajUBp4NcA4uBQ'
